...
public enum ListingTypeCodeType {
     ...
     *             <br>
     * 						<br>
     * 						<span class="tablenote"><b>Note: </b> For active fixed-price listings with listing durations other than 'GTC', sellers do not have to take any action. For listings that are automatically renewed by eBay, the renewed listings will automatically be set to 'GTC'. For any listings that are relisted by the seller, the only listing duration value that will be accepted is 'GTC'.
     * 						</span>
     * 						<br>
